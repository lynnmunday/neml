...
PYBIND11_MODULE(slipharden, m) {
  ...
  py::class_<SlipHardening, NEMLObject, std::shared_ptr<SlipHardening>>(
      m, "SlipHardening")
  ...
  py::class_<SlipSingleStrengthHardening, SlipSingleHardening,
             std::shared_ptr<SlipSingleStrengthHardening>>(
      m, "SlipSingleStrengthHardening")
  ...
  py::class_<DoubleVoceSlipHardening, PlasticSlipHardening,
             std::shared_ptr<DoubleVoceSlipHardening>>(
      m, "DoubleVoceSlipHardening")
      .def(py::init([](py::args args, py::kwargs kwargs) {
        return create_object_python<DoubleVoceSlipHardening>(
            args, kwargs, {"tau_sat_1", "b_1", "tau_sat_2", "b_2", "tau_0"});
      }));
} // PYBIND11_MODULE
